...
import kotlinx.android.synthetic.main.item_details_tile.view.*
...
class DetailsAdapterTile(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemDetailsViewHolder {
        val inflatedView =
            LayoutInflater.from(parent.context).inflate(R.layout.item_details_tile, parent, false)
    ...
    inner class ItemDetailsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        val nameDetails: TextView = itemView.name_details_tile
